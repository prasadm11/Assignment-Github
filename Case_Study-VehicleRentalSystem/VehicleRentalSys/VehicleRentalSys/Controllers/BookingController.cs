...
namespace VehicleRentalSys.Controllers
{
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var booking = await _bookingService.GetBookingByIdAsync(id);
            if (booking == null || booking.UserId != userId.Value)  // Ensure user can only edit their own booking
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int id, Booking booking)
        {
            ...
            if (existingBooking == null || existingBooking.UserId != userId.Value)  // Ensure user can only edit their own booking
            {
                return NotFound();
            }
